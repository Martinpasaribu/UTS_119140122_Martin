                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            include '../koneksi.php';
                            $id = $_GET['id_bangunan'];
                            $query = mysqli_query($koneksi, "select * from bangunan where id_bangunan='$id'");
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="id_bangunan" type="text" id="id_bangunan" class="form-control" value="<?php echo $data['id_bangunan']; ?>" readonly />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="nama_bangunan" type="text" id="nama_bangunan" class="form-control" value="<?php echo $data['nama_bangunan']; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="fasilitas" class="form-control" type="text" id="fasilitas" type="text" value="<?php echo $data['fasilitas']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
